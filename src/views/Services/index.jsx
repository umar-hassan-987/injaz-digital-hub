    ...
    <div className="bg-white text-gray-900 font-sans selection:bg-accent/20 selection:text-accent">
      ...
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-32 pb-20 bg-gray-50">
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <img 
            src={servicesImg?.src || servicesImg} 
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <Link href={`/services/${service.slug}`} className="group/btn inline-flex items-center gap-3 px-8 py-4 rounded-full bg-accent text-white font-black text-[10px] uppercase tracking-[0.3em] hover:bg-white hover:text-accent transition-all duration-500 shadow-xl shadow-accent/10 w-fit">
