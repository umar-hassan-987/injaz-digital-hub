            ...
            <div className="order-2 lg:order-1 space-y-16">
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  { icon: MapPin, label: t('contactPage.cards.address', 'Visit Us'), value: companyInfo.address, href: `https://maps.google.com/?q=${encodeURIComponent(companyInfo.address)}`, target: '_blank' },
                ].map((item, idx) => (
                  <motion.a
                    key={idx}
                    href={item.href}
