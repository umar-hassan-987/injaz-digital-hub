        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 mb-12 lg:mb-0">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-accent">Our Methodology</span>
            </div>
            <h2 className={`text-3xl lg:text-4xl font-bold font-display tracking-tight leading-[1.1] mb-8 text-gray-900`}>
              The Lifecycle <br />
              <span className="text-accent italic font-light">of Excellence</span>
            </h2>
            <p className={`text-base lg:text-lg font-medium leading-relaxed max-w-md mb-10 text-gray-600`}>
              Our structured approach ensures precision at every stage, from initial concept validation to large-scale production deployment.
            </p>
                ...
                >
                  ...
                  >
                    ...
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center border transition-all duration-500 ${
                      activeIndex === idx 
                        ...
                        : 'border-black text-black opacity-20'
                    }`}>
                  ...
                  <AnimatePresence>
                    {activeIndex === idx && (
                      ...
                      >
                        <div className="px-6 lg:px-8 pb-8 lg:pb-10 lg:pl-20">
                          <p className={`text-base font-medium leading-relaxed max-w-xl text-gray-600`}>
                            {step.description}
                          </p>
                          {idx < processSteps.length - 1 && (
                            <button 
                              onClick={() => setActiveIndex(idx + 1)}
                              className="mt-8 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-accent hover:gap-4 transition-all duration-300"
                            >
                              Next Stage <ChevronRight size={12} strokeWidth={3} />
                            </button>
                          )}
                        </div>
                      </motion.div>
