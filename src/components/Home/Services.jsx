        ...
        <div className="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-2xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-xs font-semibold uppercase tracking-[0.3em] text-[#0F5F6A]">Our Capabilities</span>
            </div>
          ...
          <div>
            <Link
              to="/services"
              className="group inline-flex items-center justify-center gap-3 bg-white border border-gray-200 text-gray-900 px-8 py-4 font-semibold text-xs uppercase tracking-widest transition-all hover:bg-[#0F5F6A] hover:text-white hover:border-[#0F5F6A] shadow-sm"
            >
  ...
  return (
    ...
    >
      <Link to={`/services/${slug}`} className="block h-full relative">
        ...
        <div className="absolute top-0 left-0 w-full h-[3px] bg-transparent group-hover:bg-[#0F5F6A] transition-colors duration-300 z-10" />
        ...
        <div className="bg-white p-8 lg:p-10 h-full transition-all duration-300 group-hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex flex-col relative z-0">
          ...
          <div className="flex items-start justify-between mb-10">
            <div className="w-14 h-14 flex items-center justify-center bg-gray-50 text-[#0F5F6A] transition-all duration-500 group-hover:bg-[#0F5F6A] group-hover:text-white border border-gray-100 group-hover:border-transparent">
              <service.icon size={26} strokeWidth={1.5} />
            </div>
            <ArrowRight size={22} className="text-gray-300 -rotate-45 group-hover:rotate-0 group-hover:text-[#0F5F6A] transition-all duration-300" />
          </div>
