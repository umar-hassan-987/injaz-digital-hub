        ...
        <div className="max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-24 xl:px-32">
          ...
          >
            ...
            <h2 className="text-[clamp(32px,6vw,64px)] font-bold text-gray-950 leading-[1.05] tracking-tight font-display mb-8">
              {t('contactPage.titlePart1', "Let's build something")}{' '}
              <span className="text-accent italic font-normal">{t('contactPage.titleHighlight', 'extraordinary.')}</span>
            </h2>
            <p className="text-xl text-gray-500 max-w-2xl leading-relaxed">
              {t('contactPage.description', 'Have a question or a project in mind? Our technical consultants are ready to help you navigate your next digital leap.')}
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[38%_62%] gap-12 lg:gap-24 items-start">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="mb-10 sm:mb-12">
                  <h3 className="text-2xl sm:text-3xl font-bold font-display tracking-tight text-gray-950 mb-3">
                    {t('contactPage.formTitle', 'Inquiry Form')}
                  </h3>
                  <p className="text-gray-500 text-base sm:text-lg">
                    {t('contactPage.formDesc', "Tell us about your vision and we'll help you realize it.")}
                  </p>
                </div>
            ...
            <div className="order-2 lg:order-1 space-y-16">
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  { icon: Mail, label: t('contactPage.cards.email', 'Email Us'), value: companyInfo.email, href: `mailto:${companyInfo.email}` },
                  { icon: Phone, label: t('contactPage.cards.phone', 'Call Us'), value: <span dir="ltr">{companyInfo.phone}</span>, href: `tel:${companyInfo.phone}` },
                  { icon: MapPin, label: t('contactPage.cards.address', 'Visit Us'), value: t('footer.address', companyInfo.address), href: `https://maps.google.com/?q=${encodeURIComponent(companyInfo.address)}`, target: '_blank' },
                ].map((item, idx) => (
                  <motion.a
                    key={idx}
                    href={item.href}
              ...
              >
                ...
                <span className="font-bold text-[15px]">{t('contactPage.whatsappCta', 'Chat with us on WhatsApp')}</span>
              </motion.a>
            </div>
